...
use Carbon\Carbon;
use Dinvoice\Mail\SendEstimateMail;
use Dinvoice\Traits\HasCustomFieldsTrait;
use Vinkla\Hashids\Facades\Hashids;
use Illuminate\Database\Eloquent\Factories\HasFactory;
use Spatie\MediaLibrary\HasMedia;
use Spatie\MediaLibrary\InteractsWithMedia;
use Dinvoice\Traits\GeneratesPdfTrait;
...
class Estimate extends Model implements HasMedia
{
    ...
    {
        return $this->hasMany('Dinvoice\Models\EstimateItem');
    }

    public function user()
    {
        return $this->belongsTo('Dinvoice\Models\User', 'user_id');
    }

    public function creator()
    {
        return $this->belongsTo('Dinvoice\Models\User', 'creator_id');
    }

    public function company()
    {
        return $this->belongsTo('Dinvoice\Models\Company');
    }
    ...
    {
        return $this->belongsTo('Dinvoice\Models\EstimateTemplate');
    }
